...
public class GameEffectAudioManager : MonoBehaviour
{
    ...
    public void SetUpAudioEffect(in AudioEffect effect, Vector3 positon, float delay = 0f)
    {
    ...
    private void SetUpFxEffect(in FxEffect fxEffect, Vector3 pos, float delay = 0f)
    {
